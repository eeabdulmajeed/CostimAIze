...
class CostimAIzeOrchestrator:
    ...
    def detect_inquiries(self, sow_text):
        prompt = f"""
أنت مساعد هندسي ذكي. استلمت نطاق عمل لمشروع كهربائي. اقرأ النص التالي، واستخرج الاستفسارات الفنية أو المعلومات الناقصة التي تحتاج إلى توضيح قبل تسعير المشروع. لا تشرح، فقط اكتب الاستفسارات بشكل نقاط واضحة:
